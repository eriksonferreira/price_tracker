...
from telegram.app.services import (
    document_send,
...
@router.post('/send_message', status_code=status.HTTP_200_OK, response_model=None)
...
@router.post('/send_multiple_messages', status_code=status.HTTP_200_OK, response_model=None)
...
@router.post('/send_document', status_code=status.HTTP_200_OK, response_model=None)
...
@router.post('/send_multiple_documents', status_code=status.HTTP_200_OK, response_model=None)
